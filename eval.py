...
def coco_test(cfg, model, data_dir, device, transform, test=False):
    if test:
        # test-dev
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        if args.dataset == 'voc':
            ...
            coco_test(cfg, model, args.root, device, transform, test=False)
        elif args.dataset == 'coco-test':
            coco_test(cfg, model, args.root, device, transform, test=True)
